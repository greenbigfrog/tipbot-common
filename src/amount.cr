module TB::Amount
  def parse_amount(coin : TB::Data::Coin, platform : TB::Data::UserType, id : Int64 | UInt64, string : String) : BigDecimal?
    if string == "all"
  ...
  private def get_balance(coin : TB::Data::Coin, platform : TB::Data::UserType, id : Int64 | UInt64)
    TB::Data::Account.read(platform, id.to_i64).balance(coin)
  end
end
